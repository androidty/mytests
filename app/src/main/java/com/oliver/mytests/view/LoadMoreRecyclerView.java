...
public class LoadMoreRecyclerView extends RecyclerView {
     ...
     * item 类型
     */
    public final static int TYPE_FOOTER = 2222;//底部--往往是loading_more
    public final static int TYPE_LIST = 3333;//代表item展示的模式是list模式
     ...
     * <p>
     * 回调加载更多方法，前提是
     * <pre>监听并且支持加载更多：null != mListener && mIsFooterEnable
     *    1、有
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == TYPE_FOOTER) {
                if (usePicture) {
                    ...
                    return new FooterViewHolder(
                            LayoutInflater.from(parent.getContext()).inflate(
                                    R.layout.default_foot_loading, parent, false));
                else {
        ...
        public class FooterViewHolder extends ViewHolder {
            public FooterViewHolder(View itemView) {
                ...
                if (usePicture) {
                    ...
                    //不是用图片动画
                    if (loadType == LoadType.AUTO_LOAD) {
                        ProgressBar progressBar = (ProgressBar) itemView.findViewById(R.id.load_more_progress);
//                        WhorlView whorlView=(WhorlView)itemView.findViewById(R.id.whorl);
//                        whorlView.start();
                    } else if (loadType == loadType.DEFAULT_LOAD) {
